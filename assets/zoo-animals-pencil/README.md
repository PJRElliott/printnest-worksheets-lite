# Zoo Animal Pencil Assets

Reusable illustrations for early-years and KS1 trace-and-write worksheets.
...
- Match the supplied zoo reference: a warm, traditional coloured-pencil sketch.
- Use fine, slightly uneven navy pencil outlines with visible contour strokes.
...
This is a practical vocabulary set, not a statutory list of required zoo species. The
England Year 1 science programme asks pupils to identify and name common animals,
including mammals, and Development Matters encourages practitioners to introduce
vocabulary for animals and the natural world.
