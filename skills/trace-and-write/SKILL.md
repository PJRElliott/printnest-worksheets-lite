...
- Place every illustration on an opaque white field that covers the handwriting guides across the entire reserved image area. Extend the field slightly past the top, left, and bottom guide edges so no line fragments show around the illustration.
